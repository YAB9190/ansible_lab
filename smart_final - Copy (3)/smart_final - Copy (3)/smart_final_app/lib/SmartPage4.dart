...
//String statusMessage = nitrogenStatusMessages[ getStatusIndexForN(dataArray['n']!)];
  ...
  final group2ModelList = [
    GroupCell1Model(
      ...
      customTextLabel: oStatusMessages[ getStatusIndexForN(dataArray['n']!)],
    ...
    GroupCell1Model(
      ...
      customTextLabel: nStatusMessages[ getStatusIndexForN(dataArray['n']!)],
      customTextLabel1: 'Today at 9:42 AM',
      customTextLabel2: 'Addis Abeba',
    ),
    GroupCell1Model(
      ...
      customTextLabel: pStatusMessages[ getStatusIndexForN(dataArray['p']!)],
      customTextLabel1: 'Today at 9:42 AM',
      customTextLabel2: 'Addis Abeba',
    ),
    GroupCell1Model(
      ...
      customTextLabel: hStatusMessages[ getStatusIndexForN(dataArray['h']!)],
      customTextLabel1: 'Today at 9:42 AM',
      customTextLabel2: 'Addis Abeba',
    ),
  ];
  ...
  @override
  State<StatefulWidget> createState() => _SmartPage4();
}

class _SmartPage4 extends State<SmartPage4> {
  @override
